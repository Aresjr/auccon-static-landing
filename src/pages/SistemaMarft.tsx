...
const SistemaMarft = () => {
  useEffect(() => {
    document.title = "Auccon - Sistema MARFT-Pro";
  }, []);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
            <div className="reveal fade-right">
              <h2 className="text-3xl font-bold mb-6 text-auccon-600">Conheça o Sistema  MARFT-Pro </h2>
              <p className="text-lg text-gray-600 mb-8">
                O Sistema  MARFT-Pro  é uma solução completa de gestão de produção em tempo real,
                desenvolvida especificamente para a indústria do vestuário. Com mais de 10 anos
                de desenvolvimento, o  MARFT-Pro  permite o controle total de todas as etapas do
          ...
          <div className="grid md:grid-cols-2 gap-12 reveal fade-bottom">
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6">
                O Sistema MARFT-Pro oferece visibilidade completa de todos os processos produtivos em tempo real.
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6">
                Integre o MARFT-Pro com seus sistemas existentes para criar um fluxo contínuo de informações.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-white p-8 rounded-lg shadow-md reveal fade-bottom">
                    ...
                    <p className="text-gray-600">
                        Implementação do Sistema MARFT-Pro para controle e monitoramento da produção em tempo real,
      ...
      <section className="py-16 md:py-24 bg-auccon-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-8 reveal fade-bottom">
            Transforme sua produção com o Sistema  MARFT-Pro
          </h2>
          <p className="text-xl max-w-3xl mx-auto mb-12 reveal fade-bottom">
            Entre em contato conosco para uma demonstração personalizada e descubra como o Sistema  MARFT-Pro
